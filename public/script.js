...
document.getElementById('login').addEventListener('submit', async function (e) {
    ...
    const response = await fetch('https://signup-login-production.up.railway.app/auth/login', {
        method: 'POST',
...
document.getElementById('signup').addEventListener('submit', async function (e) {
    ...
    // const response = await fetch('/auth/signup', {
        const response = await fetch('https://signup-login-production.up.railway.app/auth/signup', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
document.getElementById('forgot-password-form').addEventListener('submit', async function (event) {
    ...
    try {
        ...
        const response = await fetch('https://signup-login-production.up.railway.app/auth/forgot-password', {
            method: 'POST',
            headers: {
